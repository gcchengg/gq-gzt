...
export default function AssignDetail({
  ...
  const formateParams = (values) => ({
    ...
    toipcName: [...topicOptions, ...meetingOptions].find(
    ...
    fileList: fileList.map((item) => ({
      fileName: item.name,
      fileUrl: item.url || "/mock-files/uploaded.pdf",
      ...
      <div className={actId ? "topic-report-detail-grid" : ""}>
        <Form form={form} layout="vertical" disabled={!editable}>
          <Spin spinning={loading}>
            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Form.Item name="status" hidden initialValue="0" />
                <Form.Item label="状态" name="statusName" initialValue="执行中">
                  <Input disabled />
                </Form.Item>
              </Col>
              <Col span={24}>
              ...
              <Col span={12}>
                <Form.Item label="交办人id" name="assignUserId" hidden />
                <Form.Item
                  label="交办人"
                  name="assignUserName"
                  rules={[{ required: true }]}
              ...
              <Col span={12}>
                <Form.Item label="截至时间" name="deadlineDate">
                  <DatePicker style={{ width: "100%" }} />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item label="计划执行时间" name="planDate">
              ...
              <Col span={24}>
                <Form.Item
                  label="相关议题/会议名称"
                  name="itemId"
                  rules={[{ required: radioCheck !== "3" }]}
                >
                  <Select disabled={radioCheck === "3"} options={itemOptions} />
                </Form.Item>
              </Col>
            </Row>
        ...
        {actId ? (
          <div className="topic-report-approval">
            ...
            <div className="topic-report-approval-step">
              当前状态：{actStatus || "-"}
            </div>
          </div>
        ) : null}
