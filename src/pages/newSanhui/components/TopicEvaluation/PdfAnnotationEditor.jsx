...
} from "./EvaluationExecution";
import "./PdfAnnotationEditor.css";

const pages = [
  {
    page: 1,
    title: "一汽解放汽车有限公司发动机分公司31项报废设备购入及处置方案",
    section: "项目背景",
    annotated: true,
    variant: "asset",
  },
...
const seedAnnotations = [
  {
    ...
    page: 1,
    type: "框选批注",
    rect: { left: 49, top: 51, width: 43, height: 20 },
    content: "关键净值与拆除费用表格区域，需要在评估前补充附件来源说明。",
    author: "郑华峰 2025-06-21 19:05",
    favorite: true,
    needReply: true,
    ...
    discussion: [
      {
        role: "evaluator",
        name: "郑华峰",
        time: "2025-06-21 19:05",
        content:
          "请参股公司补充净值表格与拆除费用的原始附件来源，并说明是否与评估底稿一致。",
      },
      {
        role: "company",
        name: "长春富维集团",
        time: "2025-06-22 09:18",
        content:
          "已补充固定资产卡片、处置评估底稿和拆除费用说明，附件已放入本议题材料包第3项。",
      },
      {
        role: "evaluator",
        name: "郑华峰",
        time: "2025-06-22 11:32",
        content:
          "附件来源已收到。请继续补充附件日期与评估报告引用页码，便于后续闭环归档。",
      },
      {
        role: "company",
        name: "长春富维集团",
        ...
        content:
          "已在净值测算表右上角补充附件日期，并在说明中标注评估报告第12页、第15页。",
      },
      {
        role: "evaluator",
        name: "吴文君",
        time: "2025-06-23 10:10",
        content:
          "已核对，净值来源和拆除费用说明可以支撑本次评估意见，建议提报人同步更新正文描述。",
      },
      {
        role: "submitter",
        name: "刘博",
        time: "2025-06-23 14:26",
        content: "正文已按批注意见更新，并补充附件索引页。",
      },
    ],
  },
  {
    ...
    page: 1,
    type: "文字选择",
    textKey: "asset-status",
    content: "确认“无法再使用”的判断依据是否需要补充现场照片或附表说明。",
    author: "吴文君 2025-06-21 19:08",
    favorite: true,
    needReply: true,
    needCompanyReply: true,
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        role: "evaluator",
        name: "吴文君",
        time: "2025-06-21 19:08",
        content: "请参股公司补充设备现场照片，以及“无法继续使用”的判定依据。",
      },
      {
        role: "company",
        name: "长春富维集团",
        time: "2025-06-22 10:04",
        content: "已上传现场照片6张，并补充设备拆除验收单。",
      },
      {
        role: "evaluator",
        name: "吴文君",
        time: "2025-06-22 14:30",
        content:
          "照片能证明拆除状态，但还缺设备编号和照片对应关系，请按资产清单顺序补充。",
      },
      {
        role: "company",
        name: "长春富维集团",
        time: "2025-06-23 09:40",
        content:
          "已在照片文件名中补充设备编号，并新增照片编号与资产清单映射表。",
      },
    ],
  },
  {
    ...
    author: "系统预置 2026-05-15 18:06",
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        role: "evaluator",
        name: "吴文君",
        time: "2026-05-15 18:06",
        content: "建议补充现场照片作为支撑，避免判断只停留在文字描述。",
      },
      {
        role: "submitter",
        name: "刘博",
        time: "2026-05-16 09:22",
        content: "已补充现场照片，并同步到汇报材料。",
      },
      {
        role: "evaluator",
        name: "郑华峰",
        time: "2026-05-16 11:18",
        content:
          "建议把净值口径、处置价格依据和资产完备性说明拆成三条附件来源，由参股公司逐项反馈。",
      },
      {
        role: "company",
        name: "长春富维集团",
        time: "2026-05-16 16:35",
        content:
      ...
      },
      {
        role: "evaluator",
        name: "郑华峰",
        time: "2026-05-17 09:10",
        content:
          "处置价格依据已满足要求，资产完备性说明仍需补充缺失设备的处置原因。",
      },
      {
        role: "company",
        name: "长春富维集团",
        time: "2026-05-17 15:42",
        content:
          "已补充缺失设备原因，涉及设备均为前期拆除后统一暂存，未发生对外处置。",
      },
    ],
    favorite: true,
    needReply: true,
  ...
  {
    id: "pending-company-asset-owner",
    page: 1,
    type: "框选批注",
    rect: { left: 12, top: 45, width: 32, height: 18 },
    content: "请参股公司补充报废设备权属证明及资产移交确认材料。",
    author: "郑华峰 2026-05-18 09:30",
    favorite: false,
    needReply: false,
    needCompanyReply: true,
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        ...
        content:
          "请参股公司确认31项设备的权属证明、资产移交单是否齐备，并补充盖章版扫描件。",
      },
    ],
  },
  {
    id: "pending-company-tax-price",
    page: 1,
    type: "文字选择",
    textKey: "asset-status",
    content: "含税评估净值口径需参股公司确认是否包含后续拆除、运输等费用。",
    author: "吴文君 2026-05-18 10:12",
    favorite: false,
    needReply: false,
    needCompanyReply: true,
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        ...
        content:
          "请参股公司说明含税评估净值是否已包含拆除、装车、运输等后续费用，若未包含请列明预计金额。",
      },
    ],
  },
  {
    id: "pending-company-approval-file",
    page: 2,
    type: "文字选择",
    textKey: "approval-chain",
    content: "参股公司内部审批链条及会议纪要附件尚未补充。",
    author: "郑华峰 2026-05-18 11:05",
    favorite: true,
    needReply: false,
    needCompanyReply: true,
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        role: "evaluator",
        name: "郑华峰",
        time: "2026-05-18 11:05",
        content:
          "请参股公司补充本次资产处置内部审批链条、会议纪要或审批单，便于确认决策程序完整性。",
      },
    ],
  },
  {
    id: "pending-company-risk-note",
    page: 2,
    type: "框选批注",
    rect: { left: 50, top: 58, width: 36, height: 16 },
    content: "请参股公司补充资产处置后的环保、安全及残值回收风险说明。",
    author: "吴文君 2026-05-18 14:20",
    favorite: false,
    needReply: false,
    needCompanyReply: true,
    discussionVersion: seedDiscussionVersion,
    discussion: [
      {
        ...
        content:
          "请参股公司说明设备拆除及残值回收过程中的环保、安全责任划分，并补充风险控制措施。",
      },
    ],
  },
];
...
function createShareSnapshotMarkup(element) {
  ...
  clone.classList.add("pdf-share-captured-body");
...
function readScreenshotPages() {
  ...
  try {
    return (
      JSON.parse(window.localStorage.getItem(screenshotStorageKey)) ||
      defaultScreenshotPages
    );
  } catch {
...
function writeScreenshotPages(value) {
  ...
  window.dispatchEvent(
    new CustomEvent("newSanhui:annotationScreenshotPagesChange", {
      detail: value,
    }),
  );
}
...
function normalizeDiscussionItem(item, index = 0) {
  ...
  const role = normalizeDiscussionRole(item?.role);
  ...
  return {
    ...
    time: item?.time || "",
    content,
    legacyKey: `${role}-${item?.name || ""}-${content}-${index}`,
  };
}

function normalizeDiscussionList(list = []) {
  return (Array.isArray(list) ? list : [])
    .map(normalizeDiscussionItem)
    .filter((item) => item.content);
}

function normalizeDiscussionRole(role) {
  if (role === "company" || role === "参股公司") return "company";
  if (role === "submitter" || role === "提报人" || role === "创建人")
    return "submitter";
  return "evaluator";
}
...
function getDiscussionRoleText(role) {
  ...
  if (normalizedRole === "company") return "参股公司";
  if (normalizedRole === "submitter") return "提报人";
  return "评估人员";
}

function getDiscussionRoleClass(role) {
  return normalizeDiscussionRole(role);
}

function mergeDiscussionWithSeed(storedDiscussion = [], seedDiscussion = []) {
  const normalizedStored = (
    Array.isArray(storedDiscussion) ? storedDiscussion : []
  ).map(normalizeDiscussionItem);
  const normalizedSeed = normalizeDiscussionList(seedDiscussion);
  if (!normalizedStored.length) return normalizedSeed;
  const findSeedDiscussion = (discussion) =>
    normalizedSeed.find(
      (seed) =>
        seed.role === discussion.role &&
        ((seed.time && seed.time === discussion.time) ||
          (seed.name && seed.name === discussion.name)),
    );
  return normalizedStored
    .map((discussion) => {
      if (discussion.content) return discussion;
      const matchedSeed = findSeedDiscussion(discussion);
      return matchedSeed
        ? { ...discussion, content: matchedSeed.content }
        : discussion;
    })
    .filter((discussion) => discussion.content);
}

function getDiscussionContent(discussion) {
  return String(
    discussion?.content ??
      discussion?.companyAnswer ??
      discussion?.answer ??
...
function readAnnotations() {
  ...
  try {
    const stored = JSON.parse(
      window.localStorage.getItem(annotationsStorageKey),
    );
    ...
    const mergedSeeds = seedAnnotations.map((seed) => ({
      ...
      discussionVersion: seedDiscussionVersion,
      discussion:
        storedMap.get(seed.id)?.discussionVersion >= seedDiscussionVersion &&
        storedMap.get(seed.id)?.discussion?.length
          ? mergeDiscussionWithSeed(
              storedMap.get(seed.id).discussion,
              seed.discussion,
            )
          : seed.discussion,
    }));
    const extraItems = stored
      ...
      .map((item) => ({
        ...item,
        discussion: normalizeDiscussionList(item.discussion),
      }));
...
function readCompanyFeedbackRows() {
  ...
  try {
    return (
      JSON.parse(window.localStorage.getItem(companyFeedbackStorageKey)) || []
    );
  } catch {
    return [];
  }
...
function buildCompanyFeedbackFromAnnotation(annotation, fileName) {
  const existed = readCompanyFeedbackRows().find(
  ...
  return {
    ...
    feedbackTime:
      existed?.feedbackTime ||
      annotation.author?.match(/\d{4}-\d{2}-\d{2}\s+\d{2}:\d{2}/)?.[0] ||
      "2026-05-13 10:20",
    answerTime: existed?.answerTime || "",
    rounds: existed?.rounds?.length
      ? existed.rounds
      : normalizeDiscussionList(annotation.discussion),
  };
}
...
function writeAnnotations(value, activeFile = pdfFiles[0]) {
  ...
  const existedMap = new Map(
    existedRows.map((item) => [item.annotationId, item]),
  );
  ...
  window.dispatchEvent(
    new CustomEvent("newSanhui:pdfAnnotationsChange", { detail: value }),
  );
  window.dispatchEvent(
    new CustomEvent("newSanhui:companyFeedbackChange", { detail: nextRows }),
  );
}
...
export default function PdfAnnotationEditor({
  ...
  const [appRole, setAppRole] = useState(() =>
    typeof window === "undefined" ? "manager" : window.__gqAppRole || "manager",
  );
  ...
  const [factorButtonPosition, setFactorButtonPosition] = useState({
    x: 32,
    y: 116,
  });
    ...
    () =>
      pages.filter((page) => {
        if (scope === "existing")
          return (
            page.annotated ||
            annotations.some((item) => item.page === page.page)
          );
        if (scope === "new")
          return (
            !page.annotated &&
  ...
  const activePage =
    visiblePages.find((page) => page.page === currentPage) ||
    visiblePages[0] ||
    pages[0];
  const activeAnnotations = annotations.filter(
    (item) => item.page === activePage.page,
  );
  ...
  const pagedAnnotations = filteredAnnotations.slice(
    (annotationPage - 1) * 5,
    annotationPage * 5,
  );
  const isAnnotationScreenshotPage = screenshotPages[activeFile]?.includes(
    activePage.page,
  );
  const shareSelectedNames = useMemo(
    () =>
      shareUserOptions
  ...
  const shareTaskCompanyName =
    projectData?.companyName ||
    projectData?.companyShortName ||
    "一汽富华生态股份有限公司";
  const shareTaskMeetingTopicNo =
    projectData?.mgmtNo || topic?.mgmtNo || topic?.id || "-";
  ...
  useEffect(() => {
    ...
    const handleAnnotationsChange = (event) => {
      setAnnotations(
        Array.isArray(event.detail) ? event.detail : readAnnotations(),
      );
    };
    window.addEventListener(
      "newSanhui:pdfAnnotationsChange",
  ...
  useEffect(() => {
    window.dispatchEvent(
      new CustomEvent("gq:pdf-editor-task-visible", { detail: { open } }),
    );
    return () => {
      window.dispatchEvent(
        new CustomEvent("gq:pdf-editor-task-visible", {
          detail: { open: false },
        }),
      );
    };
  ...
  useEffect(() => {
    const handleAppRoleChange = (event) => {
      setAppRole(event.detail?.role || "manager");
    };
    window.addEventListener("gq:app-role-change", handleAppRoleChange);
    return () =>
      window.removeEventListener("gq:app-role-change", handleAppRoleChange);
  }, []);
    ...
    const handlePointerMove = (event) => {
      ...
      if (drag) {
        const nextX = Math.min(
          Math.max(event.clientX - drag.offsetX, 16),
          window.innerWidth - 148,
        );
        const nextY = Math.min(
          Math.max(event.clientY - drag.offsetY, 84),
          window.innerHeight - 76,
        );
        if (
          Math.abs(nextX - drag.startX) > 3 ||
          Math.abs(nextY - drag.startY) > 3
        ) {
          drag.moved = true;
        }
      ...
      if (shareDrag) {
        const nextX = Math.min(
          Math.max(event.clientX - shareDrag.offsetX, 16),
          window.innerWidth - 132,
        );
        const nextY = Math.min(
          Math.max(event.clientY - shareDrag.offsetY, 84),
          window.innerHeight - 72,
        );
        if (
          Math.abs(nextX - shareDrag.startX) > 3 ||
          Math.abs(nextY - shareDrag.startY) > 3
        ) {
  ...
  const shiftPage = (offset) => {
    const index = visiblePages.findIndex(
      (page) => page.page === activePage.page,
    );
    selectPage(
      visiblePages[
        Math.min(Math.max(index + offset, 0), visiblePages.length - 1)
      ],
    );
  };
  ...
  const saveNote = () => {
    ...
    setAnnotations((current) =>
      editing
        ? current.map((item) =>
            item.id === editing.id
              ? { ...item, content: note, needReply, needCompanyReply }
              : item,
          )
        : [
            {
              ...
              type: draftTarget?.type === "area" ? "框选批注" : "文字选择",
              rect: draftTarget?.rect,
              textKey: draftTarget?.textKey,
              content: note,
              needReply,
              needCompanyReply,
              author: "系统预置 2026-05-13 10:20",
            },
            ...current,
          ],
    );
      ...
      current.map((item) =>
        item.id === id
          ? {
              ...item,
              discussion: [
                ...normalizeDiscussionList(item.discussion),
                {
                  role: "evaluator",
                  name: "评估人员",
                  time: "刚刚",
    ...
    setShareDraftMark((mark) => {
      if (mark && mark.width >= 1 && mark.height >= 1) {
        setShareMarks((current) => [
          ...current,
          { ...mark, id: `share-mark-${Date.now()}`, text: "" },
        ]);
        setShareRedoMarks([]);
      }
      return null;
  ...
  const handleOpenShare = async () => {
    ...
    try {
      setShareSnapshotMarkup(createShareSnapshotMarkup(editorBodyRef.current));
      setShareMarks([]);
      setShareRedoMarks([]);
      setShareDraftMark(null);
      message.success("已截取当前 PDF 内容和批注列表，可选择分享人后发送");
    } catch (error) {
  ...
  const handleConfirmShare = () => {
    ...
    if (shareSendTask && !sharePlanCmplTime) {
      message.warning("请选择任务完成时间");
      return;
    }
  ...
  const toggleAnnotationScreenshotPage = (checked) => {
    ...
    message.success(
      checked ? "已标记为汇报材料页收藏" : "已取消汇报材料页收藏标记",
    );
  };
      ...
      side === "left"
        ...
        : [
            ...
            },
            {
              ...
              type: "历史批注",
              content:
                "上一版本建议将净值口径、处置价格依据和资产完备性说明拆分为三条附件来源。",
              author: "系统预置 2026-05-15 18:06",
            },
          ];
    return list.map((item) => (
      <article
        className={`pdf-task-card ${item.active ? "active" : ""}`}
        key={`${side}-${item.page}-${item.content}`}
      >
  ...
  const renderPageContent = () => {
    ...
    const contentMap = {
      ...
      normal:
        "本页为正文延续内容，用于展示完整 PDF 在评估执行场景下的分页浏览效果。",
    };
    return (
      <p className="pdf-paragraph">
        <span
          className={
            activePage.annotated ? "pdf-selectable annotated" : "pdf-selectable"
          }
        >
  ...
  const editor = (
    <>
      <section
        className={`pdf-editor-overlay open ${mode === "associate" ? "annotation-context" : "toolbar-visible"}`}
        aria-hidden={!open}
      >
        ...
        <div className="pdf-toolbar">
          <span className="pdf-toolbar-label">
            {mode === "associate" ? "关联类别：" : "标注模式："}
          </span>
          {mode === "associate" ? (
            <>
              <button
                className={`pdf-mode-btn annotation-only ${scope === "all" ? "active" : ""}`}
                type="button"
              ...
              <button
                className={`pdf-mode-btn annotation-only ${scope === "existing" ? "active" : ""}`}
                type="button"
              ...
              <button
                className={`pdf-mode-btn annotation-only ${scope === "new" ? "active" : ""}`}
                type="button"
            ...
            <div className="pdf-toolbar-switch">
              <button
                className={`pdf-mode-btn attach-only ${markMode === "area" && creationArmed ? "active" : ""}`}
                type="button"
                onClick={() => armCreation("area")}
              >
                区域标记
              </button>
              <button
                className={`pdf-mode-btn attach-only ${markMode === "text" && creationArmed ? "active" : ""}`}
                type="button"
                onClick={() => armCreation("text")}
              >
                文字选择
              </button>
            </div>
          ...
          {mode === "associate" ? (
            ...
            <span className="pdf-toolbar-hint">
              {creationArmed
                ? markMode === "area"
                  ? "拖动鼠标绘制矩形区域"
                  : "点击正文高亮文本后填写说明"
        ...
        <div className="pdf-editor-body" ref={editorBodyRef}>
          <main className="pdf-main">
            <div className="pdf-scroll">
              ...
              >
                ...
                {drawingRect ? (
                  <div className="pdf-drawing-box" style={drawingRect} />
                ) : null}
              </div>
            </div>
            ...
            <div className="pdf-page-jump">
              <button
                className="pdf-page-context-btn"
                type="button"
              ...
              <button
                ...
                type="button"
                disabled={activePage.page === visiblePages[0]?.page}
                onClick={() => shiftPage(-1)}
              >
                上一页
              </button>
              <div className="pdf-page-stepper">
                ...
                <button
                  className="pdf-page-step-btn"
                  type="button"
                  disabled={activePage.page === visiblePages.at(-1)?.page}
                  onClick={() => shiftPage(1)}
                >
                  +
                </button>
              ...
              {mode !== "associate" ? (
                <div className="pdf-page-screenshot-action">
                  <button
                    ...
                    onClick={() =>
                      toggleAnnotationScreenshotPage(
                        !isAnnotationScreenshotPage,
                      )
                    }
                  >
                    {isAnnotationScreenshotPage ? (
                  ...
                  >
                    <span
                      className="pdf-page-screenshot-tip"
                      tabIndex={0}
                      aria-label="汇报材料页收藏提示"
                    >
                      <QuestionCircleOutlined />
                    </span>
                  </Tooltip>
          ...
          <aside className="pdf-side">
            <div className="pdf-side-head">
              <div className="pdf-side-title-row">
                <div className="pdf-side-title">
                  {mode === "associate" ? "关联项列表" : "批注列表"}
                </div>
                {mode !== "associate" ? (
                  <Button
                    type="primary"
                    icon={<PlusOutlined />}
                    onClick={() => armCreation(markMode)}
                  >
                    新增
                  </Button>
                ) : null}
              ...
              <div className="pdf-side-actions">
                {mode !== "associate" ? (
                  <div
                    className="pdf-annotation-filter"
                    aria-label="批注收藏过滤"
                  >
                    <button
                    ...
                    <button
                      className={
                        annotationFilter === "favorite" ? "active" : ""
                      }
                      type="button"
                      onClick={() => {
                    ...
                    <button
                      className={
                        annotationFilter === "submitter" ? "active" : ""
                      }
                      type="button"
                      onClick={() => {
            ...
            <div className="pdf-task-scroll">
              <div className="pdf-task-list">
                {pagedAnnotations.map((item, index) => {
                  const discussionList = normalizeDiscussionList(
                    item.discussion,
                  );
                  const latestCompanyReply = discussionList.findLast(
                    (discussion) =>
                      normalizeDiscussionRole(discussion.role) === "company",
                  );
                  const isExpanded = expandedAnnotationIds.includes(item.id);
                  return (
                    <article
                      className={`pdf-task-card ${index === 0 ? "active" : ""} ${isExpanded ? "expanded" : "collapsed"}`}
                      key={item.id}
                    >
                      <div className="pdf-task-top">
                        <div className="pdf-task-tags">
                          <span className="pdf-tag pdf-tag-page">
                            第{item.page}页
                          </span>
                          <span className="pdf-tag pdf-tag-type">
                            {item.type}
                          </span>
                          {item.needReply ? (
                            <span className="pdf-tag pdf-tag-thread">
                              需提报人回复
                            </span>
                          ) : null}
                          {item.needCompanyReply ? (
                            <span className="pdf-tag pdf-tag-company">
                              需参股公司回复
                            </span>
                          ) : null}
                        </div>
                      ...
                      {discussionList.length ? (
                        <div className="pdf-task-discussion">
                          ...
                          {!isExpanded && latestCompanyReply ? (
                            <div className="pdf-discussion-company-preview">
                              <span>参股公司回复</span>
                              <p>{getDiscussionContent(latestCompanyReply)}</p>
                            </div>
                          ) : null}
                          {isExpanded ? (
                            <div className="pdf-discussion-latest">
                              {discussionList.map(
                                (discussion, discussionIndex) => (
                                  <div
                                    className={`pdf-discussion-message ${getDiscussionRoleClass(discussion.role)}`}
                                    key={
                                      discussion.legacyKey ||
                                      `${item.id}-${discussionIndex}`
                                    }
                                  >
                                    ...
                                    <div className="pdf-discussion-body">
                                      {getDiscussionContent(discussion)}
                                    </div>
                                  </div>
                                ),
                              )}
                      ...
                      {isExpanded && replyingId === item.id ? (
                        <Space.Compact
                          block
                          className="pdf-discussion-composer active"
                        >
                          <Input
                            value={reply}
                            onChange={(event) => setReply(event.target.value)}
                            placeholder="请输入建议或回复内容"
                          />
                          <Button
                            type="primary"
                      ...
                      <div className="pdf-task-foot">
                        ...
                        <div className="pdf-task-actions">
                          <button
                            type="button"
                            onClick={() => toggleAnnotationExpanded(item.id)}
                          >
                            {isExpanded ? "收起" : "展开"}
                          </button>
                          <button
                          ...
                          <button type="button" onClick={() => openNote(item)}>
                            编辑
                          </button>
                          <button
                            className="danger"
                ...
                {!filteredAnnotations.length ? (
                  <div className="pdf-empty-annotations">
                    当前筛选下暂无批注
                  </div>
                ) : null}
              </div>
        ...
        <div
          className={`pdf-compare-overlay ${compareOpen ? "open" : ""}`}
          aria-hidden={!compareOpen}
        >
          <button
            className="pdf-compare-mask"
            type="button"
            aria-label="关闭文件对比"
          ...
          <div className="pdf-compare-drawer">
            ...
            <div className="pdf-compare-drawer-head">
              ...
              <div className="pdf-compare-drawer-subtitle">
                对比文件内容与批注历史
              </div>
            </div>
                  ...
                  <div className="pdf-compare-doc">
                    ...
                    <div className="pdf-compare-page">
                      <div className="pdf-page-title">
                        {index ? "董事会会议案及表决建议" : pages[0].title}
                      </div>
                      <div className="pdf-page-rule" />
                      {index ? (
                        <>
                  ...
                  <div className="pdf-compare-side">
                    ...
                    <div className="pdf-compare-task-scroll">
                      <div className="pdf-compare-task-list">
                        {renderCompareTasks(index ? "right" : "left")}
                      </div>
                    </div>
                  </div>
                </section>
      ...
      <Drawer
        ...
        footer={
          <div className="pdf-share-footer">
            ...
            <Button type="primary" onClick={handleConfirmShare}>
              确认分享
            </Button>
          </div>
        }
      >
        <Spin spinning={shareLoading} tip="正在截取PDF内容...">
          <div className="pdf-share-content">
            <section className="pdf-share-section">
              <div className="pdf-share-section-title-row">
                ...
                <div className="pdf-share-mark-tools">
                  ...
                  <Button
                    size="small"
                    icon={<UndoOutlined />}
                    disabled={!shareMarks.length}
                    onClick={undoShareMark}
                  >
                    撤销
                  </Button>
                  <Button
                    size="small"
                    icon={<RedoOutlined />}
                    disabled={!shareRedoMarks.length}
                    onClick={redoShareMark}
                  >
                    重做
                  </Button>
                </div>
              ...
              <div className="pdf-share-shot">
                {shareSnapshotMarkup ? (
                  ...
                  >
                    <div
                      className="pdf-share-shot-content"
                      dangerouslySetInnerHTML={{ __html: shareSnapshotMarkup }}
                    />
                      ...
                      {shareMarks.map((mark) => (
                        ...
                        >
                          <textarea
                            ...
                            onPointerDown={(event) => event.stopPropagation()}
                            onChange={(event) =>
                              updateShareMarkText(mark.id, event.target.value)
                            }
                          />
                        </div>
                      ))}
                  ...
                  <div className="pdf-share-empty">
                    暂无截图，请重新点击分享按钮生成。
                  </div>
                )}
              </div>
              <div className="pdf-share-tip">
                已截取当前 PDF
                正文内容和右侧批注列表；拖拽框选后可在框内输入批注文字。
              </div>
            </section>
            ...
            <section className="pdf-share-section">
              <div className="pdf-share-section-title">是否发送任务</div>
              <div className="pdf-share-task-panel">
                <Radio.Group
                  value={shareSendTask}
                  onChange={(event) => setShareSendTask(event.target.value)}
                >
                  <Radio value={true}>是</Radio>
                  <Radio value={false}>否</Radio>
                </Radio.Group>
                {shareSendTask ? (
                  <div className="pdf-share-task-type">
                    <div className="pdf-share-task-readonly-grid">
                      <div className="pdf-share-task-field">
                        <label
                          className="pdf-share-field-label"
                          htmlFor="pdf-share-company"
                        >
                          目标公司
                        </label>
                        <Input
                          id="pdf-share-company"
                          value={shareTaskCompanyName}
                          disabled
                        />
                      </div>
                      <div className="pdf-share-task-field">
                        <label
                          className="pdf-share-field-label"
                          htmlFor="pdf-share-meeting-topic-no"
                        >
                          会议及议题编码
                        </label>
                        <Input
                          id="pdf-share-meeting-topic-no"
                          value={shareTaskMeetingTopicNo}
                          disabled
                        />
                      </div>
                    </div>
                    <div className="pdf-share-task-field pdf-share-task-select-field">
                      <label
                        className="pdf-share-field-label"
                        htmlFor="pdf-share-task-type"
                      >
                        任务类型
                      </label>
                      <Select
                        ...
                        style={{ width: "100%" }}
                        getPopupContainer={() => document.body}
                        onChange={setShareTaskType}
                      />
                    </div>
                    <div className="pdf-share-task-field pdf-share-task-date-field">
                      <label
                        className="pdf-share-field-label"
                        htmlFor="pdf-share-plan-cmpl-time"
                      >
                        任务完成时间
                      </label>
                      <DatePicker
                        id="pdf-share-plan-cmpl-time"
                        value={sharePlanCmplTime}
            ...
            <section className="pdf-share-section">
              ...
              <div
                ...
                onInput={(event) =>
                  setShareAdvice(event.currentTarget.innerHTML)
                }
              />
            </section>
          </div>
        ...
        <div className="pdf-share-success">
          ...
          {shareSelectedNames ? (
            <p>
              ...
              {shareUsers.length > 3 ? " 等" : ""}
            </p>
          ) : null}
          {shareSendTask ? (
            <p>
              同步创建协同事项任务：{shareTaskCompanyName}，完成时间{" "}
              {sharePlanCmplTime?.format?.("YYYY-MM-DD HH:mm:ss") || "-"}。
            </p>
          ) : null}
      ...
      >
        ...
        {showNeedReply ? (
          <div className="pdf-note-reply-field">
            ...
            <Radio.Group
              value={needReply}
              onChange={(event) => setNeedReply(event.target.value)}
            >
              <Radio value={true}>是</Radio>
              <Radio value={false}>否</Radio>
            </Radio.Group>
        ...
        <div className="pdf-note-reply-field">
          ...
          <Radio.Group
            value={needCompanyReply}
            onChange={(event) => setNeedCompanyReply(event.target.value)}
          >
            <Radio value={true}>是</Radio>
            <Radio value={false}>否</Radio>
          </Radio.Group>
      ...
      >
        <div
          className={`pdf-context-modal-content ${mode === "associate" ? "annotation-mode" : ""}`}
        >
          {mode === "associate" ? (
            ...
            <div className="pdf-bottom-attach-list">
              {pdfFiles.map((item) => (
                <div className="pdf-bottom-attach-row" key={item}>
                  <div className="pdf-bottom-attach-type">
                    {item.endsWith(".pdf") ? "PDF" : "DOCX"}
                  </div>
                  <button
                    className="pdf-bottom-attach-file"
                    type="button"
                    onClick={() => item.endsWith(".pdf") && setActiveFile(item)}
                  >
                    {item}
                  </button>
                  <button
          ...
          <div className="pdf-bottom-actions-row">
            {referenceActions.map((item) => (
              <button
                className="pdf-bottom-action"
                type="button"
                key={item.label}
                onClick={() => openReferenceImage(item.url)}
              >
                {item.label}
              </button>
            ))}
